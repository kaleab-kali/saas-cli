...
export const EIMS_ACCEPTANCE_CASES: readonly EimsAcceptanceCaseDefinition[] = [
	{
		...
		expectedOutcome: "EIMS accepts the invoice, returns IRN/signed QR, and print evidence contains IRN, QR, seller TIN, tax and total.",
	...
	},
	{
		...
		requiredAssertions: ["transactionType=B2B", "BuyerDetails.Tin invalid", "response.error exists", "response.Irn absent"],
	},
	{
		caseId: "IRC-N09",
		type: "negative",
	...
	},
	{
		...
		requirement: "SaaS tenant setup must capture taxpayer, branch, source, credential, certificate and environment readiness.",
		expectedOutcome: "Setup report shows enterprise, establishment, MoR source reference, credentials, certificate and blockers.",
	...
	},
	{
		...
		requirement: "Thermal and A4 print layouts must include mandatory fields and official QR only after EIMS acceptance.",
