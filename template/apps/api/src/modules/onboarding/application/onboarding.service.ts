...
export const GENERIC_ONBOARDING_STEPS: readonly OnboardingStepDefinition[] = [
	...
	},
	{
		key: "invite-team",
		stepOrder: 3,
		title: "Invite first team members",
	...
	},
	{
		...
		stepOrder: 4,
		title: "Confirm subscription and billing",
		description: "Pick a plan, confirm payment method, or validate a trial.",
		category: "billing",
		assigneeType: "STAFF",
	...
	},
	{
		...
		description: "Staff confirms the tenant has the minimum setup needed to go live.",
		category: "launch",
		assigneeType: "STAFF",
		canBeSelfService: false,
	},
