...
const PLANS: PlanSpec[] = [
	{
		...
		entitlements: [
			...
			{ featureKey: "platform.api-requests-per-minute", enabled: true, limit: 60 },
			{ featureKey: "platform.members", enabled: true, limit: 5 },
			{ featureKey: "platform.file-upload", enabled: true },
			{ featureKey: "platform.file-count", enabled: true, limit: 25 },
			{ featureKey: "platform.storage-bytes", enabled: true, limit: 52_428_800 },
			{ featureKey: "platform.custom-roles", enabled: false },
			{ featureKey: "reporting.export-xlsx", enabled: true },
		],
	},
	{
		slug: "pro",
		...
		entitlements: [
			...
			{ featureKey: "platform.api-requests-per-minute", enabled: true, limit: 600 },
			{ featureKey: "platform.members", enabled: true, limit: 25 },
			{ featureKey: "platform.file-upload", enabled: true },
			{ featureKey: "platform.file-count", enabled: true, limit: 1000 },
			{ featureKey: "platform.storage-bytes", enabled: true, limit: 1_073_741_824 },
			...
			{ featureKey: "reporting.export-xlsx", enabled: true },
			{ featureKey: "reporting.export-pdf", enabled: true },
		],
	},
	{
		slug: "enterprise",
		...
		entitlements: [
			...
			{ featureKey: "platform.api-requests-per-minute", enabled: true, limit: 6000 },
			{ featureKey: "platform.members", enabled: true },
			{ featureKey: "platform.file-upload", enabled: true },
			{ featureKey: "platform.file-count", enabled: true },
			{ featureKey: "platform.storage-bytes", enabled: true },
			{ featureKey: "platform.custom-roles", enabled: true },
			{ featureKey: "platform.custom-fields", enabled: true },
			{ featureKey: "platform.webhooks", enabled: true },
