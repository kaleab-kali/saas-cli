...
- BullMQ/Redis worker consumers for multi-node per-source submission queue locking and scheduled replay.
...
worker consumers, durable callback polling, scheduled offline replay operations, real printer/device QR certification,
